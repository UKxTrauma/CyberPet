...
const petName = [
    {
        ...
        validate: async (input) => {
            ...
            if(regex.test(input) == true || String(input).length==0)
            {
...
const start = async () => {
    ...
    console.log(art[chosenSpecies.getSpecies][0])
    status();
    greeting.greetingMain(chosenSpecies.getSpecies);
    ...
    while((hunger+thirst+mood+energy+comfort)<50) {
        ...
        if(userChoice.getChoice === "Feed") {
            ...
            greeting.greetingFeed(chosenSpecies.getSpecies);
            ...
            greeting.greetingHydrate(chosenSpecies.getSpecies);
            ...
            greeting.greetingPlay(chosenSpecies.getSpecies);
            ...
            greeting.greetingSleep(chosenSpecies.getSpecies);
            ...
            greeting.greetingClean(chosenSpecies.getSpecies);
    ...
    if((hunger+thirst+mood+energy+comfort)==50){
        console.log(art[chosenSpecies.getSpecies][1])
